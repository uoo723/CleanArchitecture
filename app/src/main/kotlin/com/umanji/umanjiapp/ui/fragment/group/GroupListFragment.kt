...
import com.umanji.umanjiapp.ui.fragment.post.adapter.GroupAdapter
import com.umanji.umanjiapp.ui.group.CreateGroupActivity
...
class GroupListFragment : BaseFragment<ActivityComponent, GroupListComponent>(), GroupListView {
...
//    @Suppress("PrivatePropertyName")
    ...
    private val postAdapter by lazy { GroupAdapter(dateUtils) }
    ...
    override fun initWidgets() {
        ...
        postAdapter.header = GroupAdapter.Header(image = "dummy")
    ...
    override fun createComponent(): GroupListComponent =
